...
const HomeProduct = ({ data }) => {
  ...
  const routeClick = (type) => {
    if (type === "search") {
      nav(`/searchProduct/${data.name}/${data.Product_id}`);
    } else {
      nav(`/displaySingleProduct/${data.name}/${data.Product_id}`);
    }
  };
  return (
      ...
      <div className="MuiGrid-root platinumrx-1eqg8k8">
        <div className="MuiGrid-root AdvantageDrugs_itemContainer__RhsPq platinumrx-rfnosa">
          ...
          <div className="MuiGrid-root AdvantageDrugs_fullDetailsContainer__EZ5i2 platinumrx-rfnosa">
            <div
              className="MuiGrid-root AdvantageDrugs_genericMedicineDetails__ZlHGp platinumrx-rfnosa"
              onClick={() => routeClick("search")}
            >
            ...
            <div
              className="MuiGrid-root AdvantageDrugs_substituteHeaderContainer__7Z3LV platinumrx-1eqg8k8"
              onClick={() => routeClick("rec")}
            >
              <div className="MuiGrid-root platinumrx-rfnosa">
                <div className="MuiGrid-root platinumrx-h451k8">
                  <div className="MuiGrid-root platinumrx-evsbey">
    ...
    //  <Link to={`/searchProduct/${data.name}/${data.Product_id}`}>
    //  </Link>
